...
The repo folder may remain `ArabicRag`. Product-facing names, OpenAPI title, and UI strings use **Geem**. Brand: [geem.ai](https://geem.ai).
...
Tenant-subdomain DX (`*.geem.dm`) and host-run API/UI are documented in [development.md](docs/development.md).
