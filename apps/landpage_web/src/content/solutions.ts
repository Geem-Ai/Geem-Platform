    ...
    },
    {
      ...
      applications: [
        ...
        },
        {
          ...
          description: 'صياغة تحديثات الفعاليات الموسمية وإجابات الأسئلة الشائعة بالعربية والإنجليزية ليراجعها الفريق قبل النشر.',
        },
      ],
      useCaseIds: ['visitor', 'customer', 'employee'],
    },
    ...
    },
    {
      ...
      applications: [
        ...
        },
        {
          ...
          description: 'صياغة أوصاف المنتجات والأسئلة الشائعة وتحديثات المحتوى من بيانات المنتجات المؤكدة، ليراجعها الفريق وينشرها.',
        },
      ],
      useCaseIds: ['customer', 'sales', 'arabic'],
    },
