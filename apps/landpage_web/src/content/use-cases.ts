...
const ar: UseCasesCopy = {
  ...
  "cases": [
    ...
    },
    {
      ...
      "outcome": "يحصل المطورون على نقطة بداية ملموسة للتنفيذ مع احتفاظهم بمسؤولية التحقق من الشيفرة واختبارها ونشرها.",
      ...
      "steps": [
        ...
        },
        {
          ...
          "description": "يراجع المطورون المسودة، ويجرون الاختبارات في بيئتهم، ويديرون النشر وفق إجراءاتهم."
        }
      ],
      "related": [
        "مسودات وثائق API",
