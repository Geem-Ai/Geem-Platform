...
const ar: AgentAiPageCopy = {
  meta: {
    title: 'دليل التكامل مع Agents AI | GEEM',
    description:
      'اربط تطبيقك بخبراء GEEM عبر Laravel AI أو عميل متوافق مع OpenAI، وتولَّ إدارة صلاحيات الأدوات وتنفيذها داخل تطبيقك.',
  },
  hero: {
    eyebrow: 'Agents AI · واجهة الوكلاء لتطبيقك',
    title: 'طوّر وكلاء ذكاء اصطناعي بمعرفة GEEM وأدوات تطبيقك',
    description:
      'اربط تطبيقك بواجهة متوافقة مع OpenAI Chat Completions لإدارة استدعاءات الأدوات. يستند النموذج في كل طلب إلى معرفة خبير واحد من مساحة العمل في GEEM، ويتولى تطبيقك تنفيذ جميع الأدوات.',
  ...
  toc: {
    ...
    items: [
      ...
      { id: 'tool-loop', label: 'تنفيذ الأدوات ومتابعة المحادثة' },
  ...
  overview: {
    eyebrow: 'نظرة عامة',
    title: 'تطبيقك يدير كل جولة مع النموذج',
    description:
      'يسترجع GEEM المعرفة المعتمدة لخبير واحد، ثم يعيد ردًا نصيًا أو استدعاءات أدوات بالصيغة القياسية. يحتفظ تطبيقك بسجل المحادثة، ويتحقق من صلاحيات تنفيذ الأدوات، وينفّذها في بيئته، ثم يعيد إرسال السجل مع النتائج.',
    facts: [
      { value: 'OpenAI', label: 'طلبات واستجابات متوافقة مع Chat Completions' },
      { value: 'خبير واحد', label: 'تحدّده صراحةً في كل طلب إكمال' },
      { value: 'صفر أدوات', label: 'ينفّذها GEEM؛ فتطبيقك يتولى تنفيذ الأدوات' },
    ],
  },
  requirements: {
    eyebrow: 'قبل أول طلب',
    title: 'استكمل متطلبات الوصول قبل البدء',
    description:
    ...
    items: [
      ...
      'أنشئ مفتاح API جديدًا، أو أعد إصدار مفتاح قائم، مع اختيار نطاق agent:write.',
      'فعّل خيار «السماح بواجهة وكيل العميل» في خبير تملكه مساحة العمل.',
      'تأكد من توفّر رصيد ضمن حصة رموز الذكاء الاصطناعي، ومن عدم بلوغ حد طلبات API في الدقيقة.',
      'تأكد من عدم استنفاد الحصة اليومية لطلبات Agents AI.',
    ],
    note: 'لا يضيف GEEM نطاق صلاحية جديدًا إلى مفتاح قائم تلقائيًا. عند انتهاء الاشتراك أو إلغاء تثبيت التطبيق، يبقى المفتاح وإعداد الخبير محفوظين، لكن الوصول إلى واجهة Agent يتوقف فورًا.',
  },
  access: {
    eyebrow: 'المصادقة',
    title: 'حدّد عنوان واجهة Agent والخبير المطلوب',
    description:
      'أرسل مفتاح API الخاص بمساحة العمل في ترويسة Authorization بصيغة Bearer. وفي طلبات الإكمال، أضف أيضًا ترويسة الخبير.',
    baseUrl: 'العنوان الأساسي للواجهة',
    publicModel: 'معرّف النموذج',
    requiredScope: 'النطاق المطلوب للمفتاح',
    expertHeader: 'ترويسة الخبير',
    modelNote:
      'لا يحدّد معرّف النموذج الخبير المستخدم. أرسل معرّف الخبير في X-Geem-Expert-Id، ويجب أن يكون الخبير تابعًا لمساحة العمل المرتبطة بالمفتاح.',
    modelsTitle: 'استعرض النماذج من دون استهلاك الحصص',
    modelsDescription:
      'يتطلب استعراض النماذج وتفاصيلها اشتراكًا مدفوعًا فعّالًا ونطاق agent:write. لا تُحتسب هذه الطلبات ضمن حد الطلبات في الدقيقة، أو حصة رموز الذكاء الاصطناعي، أو الحصة اليومية لطلبات Agents AI. ويقبل مسار التفاصيل الشرطة المائلة ضمن معرّف النموذج العام.',
  },
  quickstart: {
    eyebrow: 'ابدأ الآن',
    title: 'أرسل أول طلب إكمال من دون بث',
    description:
      'أرسل تعريفات الأدوات التي يستطيع تطبيقك تنفيذها. قد تتضمن الاستجابة ردًا نهائيًا من المساعد أو استدعاءات أدوات في choices[0].message.tool_calls.',
    requestLabel: 'طلب cURL',
  },
  toolLoop: {
    eyebrow: 'تطبيقك يدير المحادثة',
    title: 'نفّذ الأدوات، ثم تابع المحادثة بنتائجها',
    description:
      'لا يحتفظ GEEM بحالة محادثة منفصلة عن السجل الذي ترسله، ولا تحتاج إلى ترويسة جلسة خاصة. أعد إرسال الجزء اللازم من سجل المحادثة في كل جولة.',
    steps: [
      ...
      { title: 'تحقّق من الصلاحيات ثم نفّذ', description: 'تحقّق من صحة الوسائط ومن السماح بتنفيذ كل أداة داخل تطبيقك.' },
      { title: 'أعد إرسال النتائج', description: 'أرسل رسالة نتيجة واحدة بصيغة role: tool لكل استدعاء سابق، قبل إضافة أي رسالة جديدة من المستخدم أو المساعد.' },
    ],
    replayTitle: 'سجل المحادثة للمتابعة',
    replayDescription:
      'يدعم النموذج استدعاء عدة أدوات بالتوازي. أرسل نتيجة واحدة لكل استدعاء قبل إضافة رسالة جديدة من المستخدم أو المساعد. يرفض GEEM النتائج التي لا يقابلها استدعاء، والاستدعاءات المكررة أو غير المكتملة أو غير المعلنة، والرسائل التي تتخلل الاستدعاءات ونتائجها. يجري هذا التحقق قبل استرجاع المعرفة أو قبول الطلب واحتسابه ضمن الاستخدام المدفوع.',
    billingNote:
      'بعد قبول طلب الإكمال عبر HTTP، يُحتسب جولة واحدة للنموذج قابلة للفوترة، ويستهلك وحدة واحدة من الحصة اليومية لتطبيق Agents AI. ولا يحتسب GEEM تنفيذ الأدوات في تطبيقك ضمن الاستخدام.',
  },
  sdks: {
    eyebrow: 'حزم التطوير',
    title: 'استخدم حزم التطوير المألوفة دون مزوّد مخصّص',
    description:
      'يختبر GEEM باستمرار توافق إصدارات محددة من Laravel AI وحزمة OpenAI الرسمية مع صيغة الطلبات والاستجابات المعتمدة لواجهة Agent في بيئة الإنتاج.',
    laravelTitle: 'Laravel AI',
    laravelDescription:
      'استخدم المشغّل openai-compatible، وحدّد رقم إصدار ثابتًا للحزمة، وأرسل ترويسة الخبير. الإصدار v0.10.3 هو الحد الأدنى المدعوم.',
    pythonTitle: 'حزمة OpenAI الرسمية لـ Python',
    pythonDescription:
      'اضبط العنوان الأساسي لواجهة Agent وترويسة الخبير الافتراضية، ثم استخدم Chat Completions بالطريقة المعتادة.',
  },
  streaming: {
    eyebrow: 'البث واحتساب الاستخدام',
    title: 'بث SSE قياسي مع بيانات استخدام واضحة',
    description:
      'عند ضبط stream: true، تصل استدعاءات الأدوات على أجزاء مفهرسة داخل delta.tool_calls، وينتهي البث الناجح بالرسالة data: [DONE].',
    items: [
      ...
      { title: 'بيانات GEEM الإضافية', description: 'يظهر كائن geem مرة واحدة، ويعرض حالة استرجاع المعرفة والمصادر الآمنة ومدى كفاية السياق والرموز المحتسبة للفوترة.' },
    ...
    metadataTitle: 'بيانات GEEM المصاحبة للاستجابة',
    metadataDescription:
  ...
  safety: {
    ...
    description:
      'يتعامل GEEM مع تعليمات التطبيق وتعريفات الأدوات ونتائجها بوصفها مدخلات غير موثوقة. ولا تستطيع هذه المدخلات تغيير مساحة العمل أو الخبير المحدد أو صلاحيات الوصول أو الحصص أو الفوترة.',
    items: [
      'يخفّض GEEM أولوية رسائل system وdeveloper الواردة في بداية المحادثة، ويجمعها في كتلة واحدة من تعليمات التطبيق غير الموثوقة، مع ترميز المحارف الخاصة.',
      'لا تضع بيانات اعتماد أو أسرارًا في اسم الأداة أو وصفها أو مخططها أو وسائطها أو نتائجها.',
      'تحقّق من السماح بتنفيذ كل أداة ومن صحة كل وسيط قبل التنفيذ داخل تطبيقك.',
      'لا تفعّل وصول الواجهة إلى الخبير إلا إذا كان مسموحًا لحامل المفتاح وبيئة تشغيل الأدوات بالاطلاع على معرفته.',
    ],
    warningTitle: 'قد يضمّن النموذج جزءًا من المعرفة في وسائط الأداة',
    warning:
      'قد يضمّن النموذج محتوى مسترجعًا في وسائط الأدوات، ولا يضمن ترتيب أولوية التعليمات منع ذلك. لذلك تعامل مع حامل مفتاح API وبيئة تشغيل أدواته بوصفهما جهتين تتلقيان معرفة الخبير المحدد.',
  },
  controls: {
    eyebrow: 'خيارات الطلب',
    ...
    accepted: [
      ...
      'أدوات الدوال التي تستخدم JSON Schema بجذر من النوع object، مع دعم المراجع المحلية',
    ],
    rejectedTitle: 'خيارات غير مدعومة',
    rejected: [
      'مراجع المخطط الخارجية وخيار strict: true',
      'المخرجات المنظّمة أو محتوى الصور والصوت',
      'الصيغتان القديمتان functions وfunction_call',
  ...
  errors: {
    ...
    description:
      'تُعاد أخطاء المصادقة والوصول وسجل المحادثة والنموذج والحصص ومعدل الطلبات ومزوّد الخدمة برموز حالة HTTP ثابتة ومعرّفات أخطاء قابلة للقراءة آليًا.',
    retry:
      'التزم بقيمة Retry-After قبل إعادة المحاولة عند تجاوز معدل الطلبات أو الحصة. ويتضمن خطأ الحصة اليومية، داخل error.details، الحقول metric وlimit وused وremaining، إضافةً إلى reset_at بتوقيت UTC وبتنسيق RFC 3339.',
  },
  cta: {
    title: 'جاهز لربط أول وكيل بتطبيقك؟',
    description:
      'اشترك في Agents AI، وأنشئ مفتاحًا بالنطاق المطلوب، وفعّل وصول الواجهة إلى خبير واحد. يتولى تطبيقك التحقق من الصلاحيات وتنفيذ الأدوات.',
