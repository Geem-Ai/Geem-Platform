...
class AuditAction(StrEnum):
    ...
    APP_MCP_SERVER_ADDED = "app.mcp.server_added"
    APP_MCP_SERVER_REMOVED = "app.mcp.server_removed"
    APP_MCP_TOOLS_DISCOVERED = "app.mcp.tools_discovered"
    APP_MCP_TOOL_GRANTED = "app.mcp.tool_granted"
    APP_MCP_TOOL_REVOKED = "app.mcp.tool_revoked"
    APP_MCP_SURFACE_BOUND = "app.mcp.surface_bound"
    APP_MCP_SURFACE_UNBOUND = "app.mcp.surface_unbound"
    APP_MCP_TOOL_APPROVAL_DECIDED = "app.mcp.tool_approval_decided"
    APP_MCP_EXTERNAL_DELIVERY_CHANGED = "app.mcp.external_delivery_changed"
...
class AuditEntityType(StrEnum):
    ...
    MCP_PENDING_TOOL_CALL = "mcp_pending_tool_call"
    MCP_TOOL_SURFACE_BINDING = "mcp_tool_surface_binding"
    MCP_SURFACE_DELIVERY = "mcp_surface_delivery"
