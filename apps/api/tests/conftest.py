    ...
    with engine.begin() as conn:
        conn.execute(
            text(
                ...
                "connector_webhook_events, connector_sync_runs, connector_items, "
                "mcp_tool_grants, mcp_server_tools, app_connections, "
                "purchases, credit_packs, payment_gateway_configs, "
                "ai_usage_reservations, storage_reservations, workspace_resource_usage, "
                "storage_usage_events, usage_daily_workspace, usage_period_counters, credit_ledger_entries, "
                ...
                "api_keys, sessions, password_reset_tokens, email_verification_tokens, workspace_invitations, workspace_role_permissions, "
                "workspace_memberships, workspace_roles, audit_logs, workspaces, users "
