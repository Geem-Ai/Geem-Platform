  ...
  return (
    <div
      ...
      className={cn(
        ...
        tone === 'success'
          ? 'border-emerald-500/30 bg-emerald-50 text-emerald-950 dark:border-emerald-400/25 dark:bg-emerald-500/10 dark:text-emerald-100'
          : tone === 'warning'
            ? 'border-amber-500/30 bg-amber-50 text-amber-950 dark:border-amber-400/25 dark:bg-amber-500/10 dark:text-amber-100'
